...
#ifndef BLUESTACKLEVELPLAYMEDIATIONADAPTER_SWIFT_H
#define BLUESTACKLEVELPLAYMEDIATIONADAPTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BlueStackLevelPlayMediationAdapter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("ISImproveCustomAdapter")
@interface ISImproveCustomAdapter : ISBaseNetworkAdapter
...
SWIFT_CLASS_NAMED("ISImproveCustomBanner")
@interface ISImproveCustomBanner : ISBaseBanner
...
@interface ISImproveCustomBanner (SWIFT_EXTENSION(BlueStackLevelPlayMediationAdapter)) <BannerViewDelegate>
...
SWIFT_CLASS_NAMED("ISImproveCustomInterstitial")
@interface ISImproveCustomInterstitial : ISBaseInterstitial
- (void)loadAdWithAdData:(ISAdData * _Nonnull)adData delegate:(id <ISInterstitialAdDelegate> _Nonnull)delegate;
- (BOOL)isAdAvailableWithAdData:(ISAdData * _Null_unspecified)adData SWIFT_WARN_UNUSED_RESULT;
...
@interface ISImproveCustomInterstitial (SWIFT_EXTENSION(BlueStackLevelPlayMediationAdapter)) <InterstitialAdDelegate>
...
@interface ISImproveCustomInterstitial (SWIFT_EXTENSION(BlueStackLevelPlayMediationAdapter)) <FullScreenDelegate>
...
SWIFT_CLASS_NAMED("ISImproveCustomRewardedVideo")
@interface ISImproveCustomRewardedVideo : ISBaseRewardedVideo
- (BOOL)isAdAvailableWithAdData:(ISAdData * _Null_unspecified)adData SWIFT_WARN_UNUSED_RESULT;
...
@interface ISImproveCustomRewardedVideo (SWIFT_EXTENSION(BlueStackLevelPlayMediationAdapter)) <RewardedAdDelegate>
...
@interface ISImproveCustomRewardedVideo (SWIFT_EXTENSION(BlueStackLevelPlayMediationAdapter)) <FullScreenDelegate>
- (void)didDisplayAd:(id <FullScreenDisplayableAd> _Nonnull)ad;
- (void)ad:(id <FullScreenDisplayableAd> _Nonnull)ad didFailedToDisplayWithError:(NSError * _Nonnull)error;
- (void)didClickAd:(id <FullScreenDisplayableAd> _Nonnull)ad;
- (void)didDismissAd:(id <FullScreenDisplayableAd> _Nonnull)ad;
